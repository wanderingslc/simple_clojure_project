...
Two middleware functions by default which are are located in the `guestbook.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `guestbook.handler` namespace to manage the enabled middleware.
